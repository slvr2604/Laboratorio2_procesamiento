...
4. Encuentre la representación gráfica y secuencial usando Python.
         ...
         plt.subplot(3, 1, 1)
         plt.stem(x_n, x)
         plt.title("x (n) = Cédula Lina Cortés")
         plt.ylabel("x [n]")
         plt.grid(True)
         ...
         plt.subplot(3, 1, 2)
         plt.stem(h_n, h)
         plt.title("h (n) = Código Lina Cortés")
         plt.ylabel("h [n]")
         plt.grid(True)
...
4. Encuentre la representación gráfica y secuencial usando Python.
       ...
       # Grafica x(n)
       axs[0].stem(x_n, x)
       axs[0].set_title("x(n) = Cédula Alejandra Torres")
       axs[0].set_ylabel("x[n]")
       axs[0].grid(True)

       # Grafica h(n)
       axs[1].stem(h_n, h)
       axs[1].set_title("h(n) = Código Alejandra Torres")
